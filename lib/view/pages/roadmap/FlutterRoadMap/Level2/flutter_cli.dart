...
class FlutterCLI extends StatefulWidget {
  const FlutterCLI({super.key});

  @override
  State<FlutterCLI> createState() => _FlutterCLIState();
}

class _FlutterCLIState extends State<FlutterCLI> {
  @override
