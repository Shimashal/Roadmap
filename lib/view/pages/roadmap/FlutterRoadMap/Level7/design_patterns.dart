...
class DesignPatterns extends StatefulWidget {
  const DesignPatterns({super.key});

  @override
  State<DesignPatterns> createState() => _DesignPatternsState();
}

class _DesignPatternsState extends State<DesignPatterns> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              ...
              child: RichText(
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          'Here are some popular design patterns that are commonly used in Flutter development:\n',
                      style: Theme.of(context).textTheme.subtitle1,
                      children: [
                        const WidgetSpan(
                          child: Padding(
            ...
            LaunchUrl.buildLink(
              context,
              "Design Patterns Explained in 10 Minutes",
